...
function listenKeys($store, keys, listener) {
	...
	return $store.listen((value, oldValue, changed) => {
		if (changed === void 0 ? keys.some((key) => value[key] !== oldValue[key] || getPath(value, key) !== getPath(oldValue, key)) : keysSet.has(changed) || keysSet.has(changed.split(/\.|\[/)[0])) listener(value, oldValue, changed);
	});
}
//#endregion
