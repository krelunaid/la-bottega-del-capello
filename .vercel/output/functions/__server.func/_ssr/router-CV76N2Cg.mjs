...
import { c as listStylists, s as listServices } from "./salon-server-CBmt23jz.mjs";
import { n as auth } from "./server-BRBEKvj1.mjs";
import { n as TriangleAlert } from "../_libs/lucide-react.mjs";
import { t as Toaster } from "../_libs/sonner.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/router-CV76N2Cg.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: error.message || "Si è verificato un errore. Ricarica la pagina."
			})
		]
	});
}
...
var styles_default = "/assets/styles-BkIv75iL.css";
var APP_NAME = "La Bottega del Capello";
var Route$6 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Prenota da La Bottega del Capello a Chiesanuova. Stefano, Mario, Simone e Daniele. Eleganza, precisione, stile."
			},
			{
...
var $$splitComponentImporter$4 = () => import("./routes-C8OuqMMR.mjs");
...
var $$splitComponentImporter$3 = () => import("./appuntamenti-USFQvEEN.mjs");
var Route$4 = createFileRoute("/appuntamenti")({
	validateSearch: (search) => ({ code: typeof search.code === "string" ? search.code : void 0 }),
	component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
var $$splitComponentImporter$2 = () => import("./login-CLJiPzTe.mjs");
var Route$3 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./prenota-DoKVj5pB.mjs");
var Route$2 = createFileRoute("/prenota")({
	loader: async () => {
		const [stylists, services] = await Promise.all([listStylists(), listServices()]);
		return {
			stylists,
...
var $$splitComponentImporter = () => import("./sala-CnnjkK6k.mjs");
var Route$1 = createFileRoute("/sala")({ component: lazyRouteComponent($$splitComponentImporter, "component") });
...
var rootRouteChildren = {
	...
	AppuntamentiRoute: Route$4.update({
		id: "/appuntamenti",
		path: "/appuntamenti",
		getParentRoute: () => Route$6
	}),
	...
	PrenotaRoute: Route$2.update({
		id: "/prenota",
		path: "/prenota",
		getParentRoute: () => Route$6
	}),
	SalaRoute: Route$1.update({
		id: "/sala",
		path: "/sala",
		getParentRoute: () => Route$6
	}),
...
//#endregion
export { Route$5 as i, Route$2 as n, Route$4 as r, router_exports as t };
