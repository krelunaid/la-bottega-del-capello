...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CyWE0643.mjs");
...
var manifest = {
	"0576cdde656911e5197f501f3e034d241654f080dc2898b55356d26ddf75a477": {
		functionName: "listServices_createServerFn_handler",
		importer: () => import("./salon-server-BzcK9MNE.mjs")
	},
	"130686b74bd5bf777667a0912d124c8ce3e449a7aa1e356a189c2d627b08c63e": {
		functionName: "updateAppointmentStatus_createServerFn_handler",
		importer: () => import("./salon-server-BzcK9MNE.mjs")
	},
	"1b8574971bad5af412c9a4fa6761b24ffc2d96fc649b1d3317f15d805f23c5c4": {
		functionName: "saveService_createServerFn_handler",
		importer: () => import("./salon-server-BzcK9MNE.mjs")
	},
	"2169441d6808f8d1905b7eacc9045926cbc97a404a84b406f5079565387c4a11": {
		functionName: "lookupAppointment_createServerFn_handler",
		importer: () => import("./salon-server-BzcK9MNE.mjs")
	},
	"2e861dba857b0086fd08873d4374bae17b8aedb84cc9a6bc2e1a287d2d5f0c5e": {
		functionName: "listStylists_createServerFn_handler",
		importer: () => import("./salon-server-BzcK9MNE.mjs")
	},
	"313d7fa7a2d50ae75032df30beb07dd5fad0a5c680379d8c27fc867a98405cce": {
		functionName: "getDayAgenda_createServerFn_handler",
		importer: () => import("./salon-server-BzcK9MNE.mjs")
	},
	"8a0a29a9c619689b12c90410132fccfdbcb58a5c07c0876b38c38b7c33a99cdf": {
		functionName: "listMyAppointments_createServerFn_handler",
		importer: () => import("./salon-server-BzcK9MNE.mjs")
	},
	"93b9c346cbe049122ec491aabd2dfaaf47fd1987ebc89448430859f896828463": {
		functionName: "deleteService_createServerFn_handler",
		importer: () => import("./salon-server-BzcK9MNE.mjs")
	},
	"aceb270a49c402e553ca74128c5942d1fb3e6dd5a0422802e1392ed7351951b9": {
		functionName: "listAllServicesAdmin_createServerFn_handler",
		importer: () => import("./salon-server-BzcK9MNE.mjs")
	},
	"bfac57b7f1d96b760f689243e7d8ef403871b09fe39945eb52b25c408e9294a2": {
		functionName: "getAvailability_createServerFn_handler",
		importer: () => import("./salon-server-BzcK9MNE.mjs")
	},
	"e2b58d504e3ea10cf7076adc8f3d5832105491ec7f1aa177cc371586063de58a": {
		functionName: "listAgendaRange_createServerFn_handler",
		importer: () => import("./salon-server-BzcK9MNE.mjs")
	},
	"f873b0f29782f4e44abdb08de70eccbcea9cdfda2c5a649297c40ecca75411ab": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CV76N2Cg.mjs").then((n) => n.t),
